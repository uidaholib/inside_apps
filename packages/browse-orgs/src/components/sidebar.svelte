...
<div class="d-flex flex-column">
  <GroupSelection {selectedGroups} {selectedGroup} on:change />
  <div class="flex flex-col w-full bg-white rounded px-2 md:px-4 py-2 min-h-0">
    <CatalogList {selectedGroup} />
  </div>
</div>
